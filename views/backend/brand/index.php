                                    ...
                                    <tr class="datarow">
                                     ...
                                     <td>
                                          ...
                                          <?php if($item->status==1):?>
                                             ...
                                             <?php else:?>
                                                <a href="index.php?option=brand&cat=status&id=<?=$item->id;?>" 
                                                lass="btn btn-danger btn-xs">
                                                <i class="fas fa-toggle-off"></i> Ẩn
                                                </a> |
                                             <?php endif;?>
                                             <a class="btn btn-primary btn-xs text-success" 
                                             href="index.php?option=brand&cat=edit&id=<?= $item->id;?>">
                                             <i class="fa-solid fa-edit"></i> Chỉnh sửa
                                          </a> 
                                             <a class="btn btn-info btn-xs text-success" 
                                             href="index.php?option=brand&cat=show&id=<?= $item->id;?>">
                                             <i class="fa-solid fa-eye"></i> Chi tiết
                                          </a> 
                                             <a class="btn btn-danger btn-xs text-success" 
                                             href="index.php?option=brand&cat=delete&id=<?= $item->id;?>">
                                             <i class="fa-solid fa-trash-alt"></i> Xoá
                                          </a>  
                                          </div>
                                       </td>
                                       <td><?= $item->slug?></td>
